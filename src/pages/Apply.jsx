    ...
    >
      ...
      >
        ...
        <form onSubmit={submit}>
          <Question number="1" title="What is your Minecraft Username?">
            <input
              name="minecraft"
          ...
          <Question number="2" title="What is your Discord Username?">
            <input
              name="discord"
              value={form.discord}
              onChange={handleChange}
          ...
          <Question number="3" title="How old are you?">
            <input
              name="age"
              value={form.age}
              onChange={handleChange}
          ...
          <Question number="4" title="Which country are you from?">
            <input
              name="country"
              value={form.country}
              onChange={handleChange}
